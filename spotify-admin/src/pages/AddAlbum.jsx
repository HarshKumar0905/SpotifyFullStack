...
const AddAlbum = () => {
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            if(response.data.success) {
                ...
                setDesc(""); setImage(false); setName("");
            } 
            else {
    ...
    <form onSubmit={onSubmitHandler} className="flex flex-col items-start gap-8 text-gray-600">
        ...
        <div className="flex flex-col gap-3">
            ...
            <input onChange={(e)=>setColour(e.target.value)} value={colour} type="color" className="size-10 w-[140px]"/>
        </div>

        <button type="submit" className="text-base bg-green-800 text-white font-bold py-2.5 px-14 cursor-pointer w-fit rounded-md">
            ADD
        </button>
    </form>
    )
